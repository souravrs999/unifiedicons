...
export const Header: FunctionComponent = () => {
  return (
    <div className="flex flex-col px-5 py-12">
      <div className="w-full shadow-lg bg-gradient-to-br from-purple-700 to-purple-500 rounded-xl rotate-2 sm:p-5">
        <div className="flex flex-col bg-white shadow-lg rounded-xl -rotate-2 lg:flex-row">
          <div className="flex flex-col w-full row-start-1 p-5 space-y-5 lg:w-2/3">
            ...
            <h5 className="text-4xl font-black capitalize text-blue-gray-800 md:text-5xl lg:text-6xl">
          ...
          <div className="w-full p-3 border-t border-gray-200 lg:border-l lg:w-1/3">
            ...
            <div className="grid grid-cols-1 gap-4 mt-3 md:grid-cols-2 lg:grid-cols-1">
              <div className="flex items-center justify-center w-full px-3 py-5 border border-purple-200 rounded-xl">
                ...
                <svg
                  ...
                  fill="currentColor"
                  className="ml-3 text-gray-500 w-7 h-7"
                >
